...
function InputCountry(props) {
  ...
  const country = {name: 'South'};
  const states = {name: 'South'};
  const state = {name: 'South'};
    ...
    <>
        ...
        <TouchableOpacity
          ...
          <View style={styles.leftSelect}>
            {country ? (
              ...
              <Text secondary>
                {placeholder || 'account:text_select_country'}
              </Text>
            )}
          </View>
          ...
          <TouchableOpacity
            ...
            <View style={styles.leftSelect}>
              {state ? (
                ...
                <Text>{placeholderState || 'account:text_select_state'}</Text>
              )}
            </View>
            <Icon name="chevron-down" size={22} color={colors.secondaryText} />
          </TouchableOpacity>
      ...
      <Modal
        ...
        <Search
          ...
          showCancel="hidden"
          placeholder={'account:text_search_country'}
